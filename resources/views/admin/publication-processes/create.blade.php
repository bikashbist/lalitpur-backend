...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">प्रकाशन अनुमति प्रक्रिया थप्नुहोस्</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.publication-processes.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="section_description" name="section_description" 
                              rows="3" required>{{ old('section_description') }}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="download_links[0][text]" 
                                           placeholder="लिङ्कको पाठ" required>
                                </div>
                                <div class="col-md-7">
